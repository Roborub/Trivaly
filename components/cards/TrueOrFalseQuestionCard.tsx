...
export type TrueOrFalseQuestionCardProps = BaseQuestionCardProps & {
    options: TrueOrFalseQuestionAnswer[];
    explanation: string;
    onAnswer: (isCorrect: boolean) => void;
};

export default function TrueOrFalseQuestionCard(props: TrueOrFalseQuestionCardProps) {
    ...
    function handleAnswer(userAnswer: string) {
        const answer = props.options.filter(o => o.answer === userAnswer)[0];

        setAnsweredCorrectly(answer.isCorrect);
